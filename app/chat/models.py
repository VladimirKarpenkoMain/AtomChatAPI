...
class Message(Base):
    ...
    sender: Mapped["User"] = relationship("User", back_populates="sender_messages", foreign_keys=[sender_id])

    # Связь с получателем
    recipient: Mapped["User"] = relationship("User", back_populates="recipient_messages", foreign_keys=[recipient_id])
